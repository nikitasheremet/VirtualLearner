...
INSERT INTO resources (user_id, url, title, description, category) VALUES (1, 'https://www.cbc.ca/news/technology/science-survey-1.5291291', 'Canadians trust in science falling', 'Science that doesnt align with personal beliefs', 'Science');
INSERT INTO resources (user_id, url, title, description, category) VALUES (2, 'https://www.sciencenews.org/article/connecting-our-dwindling-natural-habitats-could-help-preserve-plant-diversity', 'Our dwindling natural habitats', 'An ecological experiment so big it can be seen from space.', 'Science');
INSERT INTO resources (user_id, url, title, description, category) VALUES (7, 'https://www.youtube.com/watch?v=-Qy2vist-XQ', 'How Successful People Manage Their Time', '15 Secrets Successful People Know About Time Management!', 'Project Management');
...
INSERT INTO resources (user_id, url, title, description, category) VALUES (6,'https://www.centennialcollege.ca/programs-courses/full-time/project-management/', 'Project Management at Centennial College', 'Program will provide you with the solid fundamental knowledge.', 'Project Management');
INSERT INTO resources (user_id, url, title, description, category) VALUES (1, 'https://www.youtube.com/watch?v=j5PWMI_AGAg', 'Dean Unglert spills the deets', 'Dean Unglert and Caelynn are taking things slow!', 'Other');
...
INSERT INTO resources (user_id, url, title, description, category, thumbnail_photo) VALUES (1,'http://union.playwithspirit.com/', 'Cameron Wins!', 'Legendary.', 'Sports', 'https://cdn.theatlantic.com/assets/media/img/mt/2015/05/shutterstock_247399801/lead_720_405.jpg?mod=1533691742');
